...
export class FirstPoint {
  ...
  private initEvents = () => {
    ...
    map.on("mouseup", this.onFirstPointMouseUp);
    this.initBaseEvents();
  ...
  private removeEvents() {
    ...
    map.off("mousedown", ELAYERS.FirstPointHitLayer, this.onFirstPointMouseDown);
    map.off("mouseup", this.onFirstPointMouseUp);
